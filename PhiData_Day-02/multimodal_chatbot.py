...
async def chat(msg: cl.Message):
    ...
    """
                                                                    images = []                 -> Create an empty list to store the image files
                                                                    for file in msg.elements:   -> Loop through each file in msg.elements
                                                                    if "image" in file.mime:    -> Check if "image" is in the file's mime type
                                                                    images.append(file)
    """
